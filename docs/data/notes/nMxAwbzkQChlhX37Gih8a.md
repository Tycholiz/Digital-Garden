...
Sharding is a special type of horizontal [[db.distributed.partitioning]] where partitions spans across multiple [[database replicas|db.distributed.replication]].

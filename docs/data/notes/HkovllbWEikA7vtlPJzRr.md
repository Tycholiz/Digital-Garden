...
remember that the `<jsx/>` syntax always produces a *NEW* immutable React element. So, a component that receives `<jsx/>` as props always re-renders
- [more info](https://medium.com/welldone-software/why-did-you-render-mr-big-pure-react-component-part-2-common-fixing-scenarios-667bfdec2e0f)

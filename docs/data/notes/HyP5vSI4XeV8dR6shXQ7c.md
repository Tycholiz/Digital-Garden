...
# CloudFront
CloudFront is a [[CDN|deploy.distributed.CDN]] AWS-service which operates at Edge Locations around the world closer to the users. It can cache the static assets and deliver them to the end-users quite fast.

...
## When to use them?
There are two major places where we can consider indexing: 
1. columns referenced in the WHERE clause 
2. columns used in JOIN clauses. 

In short, such columns should be indexed against which you are required to search particular records

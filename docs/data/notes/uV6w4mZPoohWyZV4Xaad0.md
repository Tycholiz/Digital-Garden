...
2. *release stage* - takes the build and combines it with the deploy's current config, producing something that is ready for immediate execution in an environment.

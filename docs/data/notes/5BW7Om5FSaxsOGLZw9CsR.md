...
- when the problem has us finding the mix, max, longest, shortest
- we are looking at subarrays within the array
...
## Resources
- [Algorithmic Mental Modal of Sliding Window](https://www.youtube.com/watch?v=MK-NZ4hN7rs)
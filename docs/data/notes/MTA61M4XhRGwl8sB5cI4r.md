...
### Normal
- paste from buffer - `]`
- send the contents of the current buffer to a temp file - `P` (custom bind)
...
### Other
- edit tmux.conf - `e` (custom bind)
- source tmux.conf - `r` (custom bind)
- see all commands - `Prefix:list-keys`, `Prefix ?`, `$ tmux list-keys`

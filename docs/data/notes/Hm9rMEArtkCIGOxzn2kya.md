...
Since everything in Javascript is an object, `Array` doesn't follow the same limitations as an actual [[array|general.lang.data-structs.array]], such as being of fixed length.

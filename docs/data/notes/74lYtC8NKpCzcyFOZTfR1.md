...
JSON Schema allows us to validate our JSON documents. We can create a `json` file for each domain object (ie. what we would find in each table of an [[SQL|sql]] db), and we specify things like...

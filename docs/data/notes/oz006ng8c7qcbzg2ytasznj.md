...
We pass the class rather than an instantiation of the class, leaving the responsibility of instantiation up to the framework. This is to enable [[dependency injection|general.patterns.dependency-injection]].

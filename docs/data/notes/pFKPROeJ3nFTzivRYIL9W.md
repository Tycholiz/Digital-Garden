...
- [Dexie](https://github.com/dexie/Dexie.jshttps://github.com/FLVieira/sync-api/blob/master/src/app/controllers/SynchronizationController.js)

## E Resources
- [myTunes: using SQLite to create a reactive app](https://riffle.systems/essays/prelude/)
- [local-first apps](https://www.inkandswetch.com/local-first/)

...
With [[postgraphile]], `rootPgPool` is not normally used because its privileges are too elevated. Typically you use `rootPgPool` for authentication tasks like in [[auth.passport]]

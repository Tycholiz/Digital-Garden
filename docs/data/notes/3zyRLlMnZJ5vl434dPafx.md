...
```js
// each time the loop runs, it checks to see if the place equals the address. If it does, then there is an automatic retry done, accomplished with the do-while

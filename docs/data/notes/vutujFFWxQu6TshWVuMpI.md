...
- [[Replication|db.distributed.replication]] - Keeping a copy of the same data on several different nodes, potentially in different locations. 
  - provides redundancy and can also help improve performance.
...
The simplest implementation of a distributed system is a [[client-server architecture|general.arch.client-server]].
...
- anal: [[protocol.TCP]] is a relible protocol built on the unreliable IP.

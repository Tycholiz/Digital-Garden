...
### Event forwarding
Unlike DOM events, component events don't [[bubble|js.arch.event-loop.event-bubbling]]. If you want to listen to an event on a deeply nested component, the intermediate components must *forward* the event.

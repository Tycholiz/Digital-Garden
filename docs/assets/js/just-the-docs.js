(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://tycholiz.github.io/Digital-Garden/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://tycholiz.github.io/Digital-Garden/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://tycholiz.github.io/Digital-Garden/assets/css/just-the-docs-' + theme + ".css"
      );
    };
